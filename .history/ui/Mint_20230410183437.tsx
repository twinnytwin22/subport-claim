      ...
      <div className="max-w-md w-full mx-auto flex flex-col">
        ...
        {editing ? (
          <div className="button-container">
            ...
            <button className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' 
            disabled={loading} onClick={mintDomain}>
           Claim            
           </button>
          )}
      </div>
              ...
              return (
                <div className="mint-item" key={index}>
                  <div className='mint-row'>
                    ...
                    {mint.owner.toLowerCase() === address.toLowerCase() ?
            <button className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' 
        ...
        <div className="pt-8">
          <div className='flex p-8 justify-between items-center'>
            ...
            <img src="/images/subport.png" className="mx-3  w-9" alt="Subport Logo" />
              <h1 className="text-lg font-bold">subport</h1></Link>
            </div>
            ...
            <div className="flex border border-zinc-600 p-3 rounded-lg mr-[10%]">
              ...
              {address ? <p>  {address.slice(0, 6)}...{address.slice(-4)} </p> : <p> Not connected </p>}
