...
const Mint = () => {
  ...
  return (
    <div className="h-screen mx-auto w-full text-white">
      <div className="flex flex-col w-full h-full p-20 justify-between">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">Performer Repository Name Service</p>
              <p className="subtitle">by CRIB</p>
              <p className="description">Compostion Repertoire Interoperable via Blockchain</p>
            </div>
