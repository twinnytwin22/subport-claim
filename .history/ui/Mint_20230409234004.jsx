  ...
  const renderInputForm = () => {
    ...
    return (
      <div className="form-container">
        ...
        <div className="flex justify-between mb-3 items-center content-center relative border-zinc-700 border rounded-xl h-fit">

        <input className="bg-zinc-900  focus:ring-zinc-500 focus:ring"
          type="text"
          value={record}
      ...
      <div className="flex flex-col w-full h-full p-10 justify-between">
        <div className="pt-8">
          <div className='flex p-8 justify-between items-center'>
            ...
            <div className="flex border border-zinc-600 p-3 rounded-lg">
